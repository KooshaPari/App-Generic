...
export default function IPhone1415Pro10() {
    return (
    		<View style={styles.iPhone1415Pro10}>
      			<View style={styles.rectangle7}/>
      			<View style={styles.rectangle15}/>
      			<Text style={styles.linkaDevice}>
        				{`Link a Device`}
      			</Text>
      			<Text style={styles.useAkomaonwebdesktopandotherdevices}>
        				{`Use Akoma on web desktop, and other devices`}
      			</Text>
...
const styles = StyleSheet.create({
    ...
    letterSpacing: 0
  	...
  	useAkomaonwebdesktopandotherdevices: {
    position: "absolute",
    flexShrink: 0,
    top: 198,
    left: 22,
